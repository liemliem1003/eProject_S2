...
@section("title") {{$phone['tensp']}} |HaiLuaMobile @stop
@section("content")

@section("breadcrumb")
    <a href="{{route('user/pages/shop')}}" class="bc-item"></a>
...
@stop
@include("user.pages.shop.section.sec-thanh-dieu-huong")
        ...
        <div class='row'>
                ...
                <div class='d-flex flex-column'>
                    ...
                    <div class='detail-another-div'>
                        <div id='detail-carousel' class="owl-carousel">
                            @foreach($lst_variation['images'] as $key)
            ...
            @if ($phone['modelStatus'])
                ...
                <div class='col-lg-4 col-md-8 mb-20'>
                    @include('user.pages.shop.components.chitiet.right-side')
                </div>
            @else
                <div class='col-lg-4 col-md-6 mb-20 fz-14'>
                    ...
                    <div>
                        Liên hệ
                        <b class="ml-5 mr-5">0000000000</b>hoặc
                        <b class="ml-5 mr-5">--0000000 </b> Để được tư vấn
                    </div>
                    <hr>
                    @include('user.pages.shop.components.chitiet.right-side')
                </div>
                ...
                <div class='col-lg-4 col-md-8 mb-20'>    
                    @include('user.pages.shop.components.chitiet.thong-so-ky-thuat')
                </div>
            @endif
        </div> <hr>
...
{{-- delete modal --}}
@include("user.pages.shop.modal.xoa")
